...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      'All public registrations are USER. Becoming a SUPPLIER requires a separate application approved by ADMIN.',
  })
  @ApiCreatedResponse({
  ...
  @ApiOkResponse({ description: 'DECOHO access and refresh tokens returned' })
